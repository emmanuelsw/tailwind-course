    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="sm:block">
      ...
      <div class="px-4 py-5 border-t border-gray-800 sm:hidden">
        <div class="flex items-center">
          <img class="h-8 w-8 border-2 border-gray-600 rounded-full object-cover" :src="imageUrl" alt="Your avatar">
          <span class="ml-3 font-semibold text-white">Emmanuel Deossa</span>
        </div>
        <div class="mt-3">
